...
const person1 = { name: 'Person1', age: 21, favoriteFoods: ['carrot'] };
const person2 = { name: 'Person2', age: 22, favoriteFoods: ['lettuce'] };
const person3 = { name: 'Person3', age: 23, favoriteFoods: ['tomato'] };
